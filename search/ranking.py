...
# -------------------
#
# The concrete implementation in database.repository is expected to:
#
# * use prepared statements exclusively
# * execute SQLite FTS5 MATCH queries
# * calculate bm25(paragraph_fts)
# * apply source/year/document filters
# * return paragraph-level rows
...
# -----------------------
#
# Future semantic ranking should occur ONLY inside
# _postprocess_results().
#
# This preserves the public API:
#
#     execute_ranked_search(...)
#
# and avoids changes to callers in search.service or the Shiny UI.
#
# Planned pipeline:
#
#     FTS5 BM25
...
#     _postprocess_results()
#          │
#          ├── topic-anchor boosting
#          ├── embedding similarity
#          ├── LLM verification (optional)
#          └── personalised ranking (optional)
#
# The current implementation intentionally returns the BM25-ranked
# results unchanged.
#
